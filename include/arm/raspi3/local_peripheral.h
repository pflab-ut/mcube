/**
 * @file include/arm/raspi3/local_peripheral.h
 *
...
#define LP_GPU_INTERRUPTS_ROUTING (LOCAL_PERIPHERAL_BASE + 0xc)
#define LP_PERFORMANCE_MONITOR_INTERRUPTS_ROUTING_SET (LOCAL_PERIPHERAL_BASE + 0x10)
#define LP_PERFORMANCE_MONITOR_INTERRUPTS_ROUTING_CLEAR (LOCAL_PERIPHERAL_BASE + 0x14)
...
#define LP_CORE0_TIMERS_INTERRUPT_CTRL (LOCAL_PERIPHERAL_BASE + 0x40)
#define LP_CORE1_TIMERS_INTERRUPT_CTRL (LOCAL_PERIPHERAL_BASE + 0x44)
#define LP_CORE2_TIMERS_INTERRUPT_CTRL (LOCAL_PERIPHERAL_BASE + 0x48)
#define LP_CORE3_TIMERS_INTERRUPT_CTRL (LOCAL_PERIPHERAL_BASE + 0x4c)
#define LP_CORE0_MAILBOXES_INTERRUPT_CTRL (LOCAL_PERIPHERAL_BASE + 0x50)
#define LP_CORE1_MAILBOXES_INTERRUPT_CTRL (LOCAL_PERIPHERAL_BASE + 0x54)
#define LP_CORE2_MAILBOXES_INTERRUPT_CTRL (LOCAL_PERIPHERAL_BASE + 0x58)
#define LP_CORE3_MAILBOXES_INTERRUPT_CTRL (LOCAL_PERIPHERAL_BASE + 0x5c)
#define LP_CORE0_IRQ_SRC (LOCAL_PERIPHERAL_BASE + 0x60)
#define LP_CORE1_IRQ_SRC (LOCAL_PERIPHERAL_BASE + 0x64)
#define LP_CORE2_IRQ_SRC (LOCAL_PERIPHERAL_BASE + 0x68)
#define LP_CORE3_IRQ_SRC (LOCAL_PERIPHERAL_BASE + 0x6c)
#define LP_CORE0_FIQ_SRC (LOCAL_PERIPHERAL_BASE + 0x70)
#define LP_CORE1_FIQ_SRC (LOCAL_PERIPHERAL_BASE + 0x74)
#define LP_CORE2_FIQ_SRC (LOCAL_PERIPHERAL_BASE + 0x78)
#define LP_CORE3_FIQ_SRC (LOCAL_PERIPHERAL_BASE + 0x7c)
#define LP_CORE0_MAILBOX0_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0x80)
#define LP_CORE0_MAILBOX1_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0x84)
#define LP_CORE0_MAILBOX2_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0x88)
#define LP_CORE0_MAILBOX3_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0x8c)
#define LP_CORE1_MAILBOX0_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0x90)
#define LP_CORE1_MAILBOX1_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0x94)
#define LP_CORE1_MAILBOX2_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0x98)
#define LP_CORE1_MAILBOX3_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0x9c)
#define LP_CORE2_MAILBOX0_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0xa0)
#define LP_CORE2_MAILBOX1_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0xa4)
#define LP_CORE2_MAILBOX2_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0xa8)
#define LP_CORE2_MAILBOX3_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0xac)
#define LP_CORE3_MAILBOX0_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0xb0)
#define LP_CORE3_MAILBOX1_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0xb4)
#define LP_CORE3_MAILBOX2_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0xb8)
#define LP_CORE3_MAILBOX3_WRITE_SET (LOCAL_PERIPHERAL_BASE + 0xbc)
#define LP_CORE0_MAILBOX0_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xc0)
#define LP_CORE0_MAILBOX1_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xc4)
#define LP_CORE0_MAILBOX2_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xc8)
#define LP_CORE0_MAILBOX3_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xcc)
#define LP_CORE1_MAILBOX0_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xd0)
#define LP_CORE1_MAILBOX1_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xd4)
#define LP_CORE1_MAILBOX2_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xd8)
#define LP_CORE1_MAILBOX3_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xdc)
#define LP_CORE2_MAILBOX0_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xe0)
#define LP_CORE2_MAILBOX1_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xe4)
#define LP_CORE2_MAILBOX2_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xe8)
#define LP_CORE2_MAILBOX3_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xec)
#define LP_CORE3_MAILBOX0_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xf0)
#define LP_CORE3_MAILBOX1_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xf4)
#define LP_CORE3_MAILBOX2_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xf8)
#define LP_CORE3_MAILBOX3_READ_WRITE_HIGH_TO_CLEAR (LOCAL_PERIPHERAL_BASE + 0xfc)
 ...
 */ 
#define LP_GPU_INTERRUPT_ROUTING_FIQ_CORE0 (0x0 << 2)
#define LP_GPU_INTERRUPT_ROUTING_FIQ_CORE1 (0x1 << 2)
#define LP_GPU_INTERRUPT_ROUTING_FIQ_CORE2 (0x2 << 2)
#define LP_GPU_INTERRUPT_ROUTING_FIQ_CORE3 (0x3 << 2)
...
*/
#define LP_GPU_INTERRUPT_ROUTING_IRQ_CORE0 (0x0 << 0)
#define LP_GPU_INTERRUPT_ROUTING_IRQ_CORE1 (0x1 << 0)
#define LP_GPU_INTERRUPT_ROUTING_IRQ_CORE2 (0x2 << 0)
#define LP_GPU_INTERRUPT_ROUTING_IRQ_CORE3 (0x3 << 0)
 ...
 * 1 = IRQ Enabled
 */
#define LP_PERFORMANCE_MONITOR_INTERRUPTS_ROUTING_SET_ENABLE(x) (0x1 << (x))
#define LP_PERFORMANCE_MONITOR_INTERRUPTS_ROUTING_CLEAR_ENABLE(x) (0x1 << (x))
 ...
 */
#define LP_LOCAL_INTERRUPT_ROUTING_CORE0_IRQ 0x0
#define LP_LOCAL_INTERRUPT_ROUTING_CORE1_IRQ 0x1
#define LP_LOCAL_INTERRUPT_ROUTING_CORE2_IRQ 0x2
#define LP_LOCAL_INTERRUPT_ROUTING_CORE3_IRQ 0x3
#define LP_LOCAL_INTERRUPT_ROUTING_CORE0_FIQ 0x4
#define LP_LOCAL_INTERRUPT_ROUTING_CORE1_FIQ 0x5
#define LP_LOCAL_INTERRUPT_ROUTING_CORE2_FIQ 0x6
#define LP_LOCAL_INTERRUPT_ROUTING_CORE3_FIQ 0x7
 ...
 * 1 = IRQ Enabled
 */
#define LP_CORE_MAILBOXES_INTERRUPT_CTRL_ENABLE(x) (0x1 << (x))
...
#define LP_CORE_IRQ_SRC_MAILBOX3_INTERRUPT (0x1 << 7)
/* 6: Mailbox 2 Interrupt */
#define LP_CORE_IRQ_SRC_MAILBOX2_INTERRUPT (0x1 << 6)
/* 5: Mailbox 1 Interrupt */
#define LP_CORE_IRQ_SRC_MAILBOX1_INTERRUPT (0x1 << 5)
/* 4: Mailbox 0 Interrupt */
#define LP_CORE_IRQ_SRC_MAILBOX0_INTERRUPT (0x1 << 4)
/* 3: CNTVIRQ Interrupt */
...
#define LP_CORE_FIQ_SRC_MAILBOX3_INTERRUPT (0x1 << 7)
/* 6: Mailbox 2 Fast Interrupt */
#define LP_CORE_FIQ_SRC_MAILBOX2_INTERRUPT (0x1 << 6)
/* 5: Mailbox 1 Fast Interrupt */
#define LP_CORE_FIQ_SRC_MAILBOX1_INTERRUPT (0x1 << 5)
/* 4: Mailbox 0 Fast Interrupt */
#define LP_CORE_FIQ_SRC_MAILBOX0_INTERRUPT (0x1 << 4)
