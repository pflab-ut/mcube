/**
 * @file include/aarch64/sys_regs.h
 *
 * @author Hiroyuki Chishiro
 */
#ifndef __MCUBE_AARCH64_SYS_REGS_H__
#define __MCUBE_AARCH64_SYS_REGS_H__
 ...
 */
/**
 * @def CNTV_CTL_EL0_IMASK_NOT_MASKED
 * @brief Timer interrupt is not masked.
 */
#define CNTV_CTL_EL0_IMASK_NOT_MASKED (0x0 << 1)
/**
 * @def CNTV_CTL_EL0_IMASK_MASKED
 * @brief Timer interrupt is masked.
 */
 ...
 */
/**
 * @def ESR_ELx_EC_SHIFT
 * @brief ESR shift.
 */
#define ESR_ELx_EC_SHIFT 26

/**
 * @def ESR_ELx_EC_UNKNOWN_REASON
 * @brief ESR unknown reason.
 */
#define ESR_ELx_EC_UNKNOWN_REASON 0x1

/**
 * @def ESR_ELx_EC_WFI_OR_WFE_INSTRUCTION_EXCEPTION
 * @brief ESR @c wfi or @c wfe instruction exception.
 */
#define ESR_ELx_EC_WFI_OR_WFE_INSTRUCTION_EXCEPTION 0x2

/**
 * @def ESR_ELx_EC_MCR_OR_MRC_ACCESS_TO_CP15
 * @brief ESR @c mcr or @c mrc access to CP15.
 */
#define ESR_ELx_EC_MCR_OR_MRC_ACCESS_TO_CP15 0x3

/**
 * @def ESR_ELx_EC_MCRR_OR_MRRC_ACCESS_TO_CP15
 * @brief ESR @c mcrr or @c mrrc access to CP15.
 */
#define ESR_ELx_EC_MCRR_OR_MRRC_ACCESS_TO_CP15 0x4

/**
 * @def ESR_ELx_EC_MCR_OR_MRC_ACCESS_TO_CP14
 * @brief ESR @c mcr or @c mrc access to CP14.
 */
#define ESR_ELx_EC_MCR_OR_MRC_ACCESS_TO_CP14 0x5

/**
 * @def ESR_ELx_EC_LDC_OR_STC_ACCESS_TO_CP14
 * @brief ESR @c ldc or @c stc access to CP14.
 */
#define ESR_ELx_EC_LDC_OR_STC_ACCESS_TO_CP14 0x6

/**
 * @def ESR_ELx_EC_ACCESS_TO_SIMD_OR_FP_REG
 * @brief ESR access to SIMD or FP registers.
 */
#define ESR_ELx_EC_ACCESS_TO_SIMD_OR_FP_REG 0x7

/**
 * @def ESR_ELx_EC_MCR_MRC_ACCESS_TO_CP10
 * @brief ESR @c mcr @c mrc access to CP10.
 */
...
/**
 * @def ESR_ELx_EC_MRRC_ACCESS_TO_CP14
 * @brief ESR @c mrrc access to CP14.
 */
...
/**
 * @def ESR_ELx_EC_ILLEGAL_EXECUTION_STATE
 * @brief ESR Illegal execution state.
 */
#define ESR_ELx_EC_ILLEGAL_EXECUTION_STATE 0xe

/**
 * @def ESR_ELx_EC_SVC_INSTRUCTION_EXCEPTION32
 * @brief ESR @c svc instruction exception in AArch32 state.
 */
#define ESR_ELx_EC_SVC_INSTRUCTION_EXCEPTION32 0x11

/**
 * @def ESR_ELx_EC_HVC_INSTRUCTION_EXCEPTION32
 * @brief ESR @c hvc instruction exception in AArch32 state.
 */
#define ESR_ELx_EC_HVC_INSTRUCTION_EXCEPTION32 0x12

/**
 * @def ESR_ELx_EC_SMC_INSTRUCTION_EXCEPTION32
 * @brief ESR @c smc instruction exception in AArch32 state.
 */
...
/**
 * @def ESR_ELx_EC_SVC_INSTRUCTION_EXCEPTION64
 * @brief ESR @c svc instruction exception in AArch64 state.
 */
#define ESR_ELx_EC_SVC_INSTRUCTION_EXCEPTION64 0x15

/**
 * @def ESR_ELx_EC_HVC_INSTRUCTION_EXCEPTION64
 * @brief ESR @c hvc instruction exception in AArch64 state.
 */
#define ESR_ELx_EC_HVC_INSTRUCTION_EXCEPTION64 0x16

/**
 * @def ESR_ELx_EC_SMC_INSTRUCTION_EXCEPTION64
 * @brief ESR @c smc instruction exception in AArch64 state.
 */
#define ESR_ELx_EC_SMC_INSTRUCTION_EXCEPTION64 0x17

/**
 * @def ESR_ELx_EC_MSR_MRS_SYSTEM_EXCEPTION64
 * @brief ESR @c msr @c mrs system instruction in AArch64 state.
 */
...
/**
 * @def ESR_ELx_EC_INSTRUCTION_ABORT_FROM_LOWER_EXCEPTION_LEVEL
 * @brief ESR instruction abort from lower exception level.
 */
#define ESR_ELx_EC_INSTRUCTION_ABORT_FROM_LOWER_EXCEPTION_LEVEL 0x20

/**
 * @def ESR_ELx_EC_INSTRUCTION_ABORT_TAKEN_WITHOUT_A_CHANGE_IN_EXCEPTION_LEVEL
 * @brief ESR instruction abort taken without a change in exception level.
 */
#define ESR_ELx_EC_INSTRUCTION_ABORT_TAKEN_WITHOUT_A_CHANGE_IN_EXCEPTION_LEVEL 0x21

/**
 * @def ESR_ELx_EC_MISALIGNED_PC_EXCEPTION
 * @brief ESR misaligned PC exception.
 */
...
/**
 * @def ESR_ELx_EC_DATA_ABORT_FROM_A_LOWER_EXCEPTION_LEVEL
 * @brief ESR data abort from a lower exception level.
 */
#define ESR_ELx_EC_DATA_ABORT_FROM_A_LOWER_EXCEPTION_LEVEL 0x24

/**
 * @def ESR_ELx_EC_DATA_ABORT_TAKEN_WITHOUT_A_CHANGE_IN_EXCEPTION_LEVEL
 * @brief ESR data abort taken without a change in exception level.
 */
#define ESR_ELx_EC_DATA_ABORT_TAKEN_WITHOUT_A_CHANGE_IN_EXCEPTION_LEVEL 0x25

/**
 * @def ESR_ELx_EC_STACK_POINTER_ALIGNMENT_EXCEPTION
 * @brief ESR stack pointer alignment exception.
 */
...
/**
 * @def ESR_ELx_EC_FLOATING_POINT_EXCEPTION32
 * @brief ESR floating point exception in AArch32 state.
 */
...
/**
 * @def ESR_ELx_EC_FLOATING_POINT_EXCEPTION64
 * @brief ESR floating point exception in AArch64 state.
 */
...
/**
 * @def ESR_ELx_EC_SERROR_INTERRUPT
 * @brief ESR serror interrupt.
 */
#define ESR_ELx_EC_SERROR_INTERRUPT 0x2f

/**
 * @def ESR_ELx_EC_BREAKPOINT_EXCEPTION_FROM_A_LOWER_EXCEPTION_LEVEL
 * @brief ESR breakpoint exception from a lower exception level.
 */
#define ESR_ELx_EC_BREAKPOINT_EXCEPTION_FROM_A_LOWER_EXCEPTION_LEVEL 0x30

/**
 * @def ESR_ELx_EC_BREAKPOINT_EXCEPTION_WITHOUT_A_CHANGE_IN_EXCEPTION_LEVEL
 * @brief ESR breakpoint exception without a change in exception level.
 */
#define ESR_ELx_EC_BREAKPOINT_EXCEPTION_WITHOUT_A_CHANGE_IN_EXCEPTION_LEVEL 0x31

/**
 * @def ESR_ELx_EC_SOFTWARE_STEP_EXCEPTION_FROM_A_LOWER_EXCEPTION_LEVEL
 * @brief ESR software step exception from a lower exception level.
 */
#define ESR_ELx_EC_SOFTWARE_STEP_EXCEPTION_FROM_A_LOWER_EXCEPTION_LEVEL 0x32

/**
 * @def ESR_ELx_EC_SOFTWARE_STEP_EXCEPTION_TAKEN_WITHOUT_A_CHANGE_IN_EXCEPTION_LEVEL
 * @brief ESR software step exception taken without a change in exception level.
 */
#define ESR_ELx_EC_SOFTWARE_STEP_EXCEPTION_TAKEN_WITHOUT_A_CHANGE_IN_EXCEPTION_LEVEL 0x33

/**
 * @def ESR_ELx_EC_WATCHPOINT_EXCEPTION_FROM_A_LOWER_EXCEPTION_LEVEL
 * @brief ESR watchpoint exception from a lower exception level.
 */
#define ESR_ELx_EC_WATCHPOINT_EXCEPTION_FROM_A_LOWER_EXCEPTION_LEVEL 0x34

/**
 * @def ESR_ELx_EC_WATCHPOINT_EXCEPTION_WITHOUT_A_CHANGE_IN_EXCEPTION_LEVEL
 * @brief ESR watchpoint exception without a change in exception level.
 */
...
/**
 * @def ESR_ELx_EC_BKPT_INSTRUCTION_EXCEPTION
 * @brief ESR @c bkpt instruction exception.
 */
...
/**
 * @def ESR_ELx_EC_VECTOR_CATCH_EXCEPTION_FROM_AARCH32_STATE
 * @brief ESR vector catch exception from AArch32 state.
 */
...
/**
 * @def ESR_ELx_EC_BRK_INSTRUCTION_EXCEPTION
 * @brief ESR @c brk instruction exception.
 */
 ...
 */
/**
 * @def ESR_ELx_IL_16BIT_INSTRUCTION_TRAPPED
 * @brief ESR 16-bit T32 BKPT instruction.
 */
#define ESR_ELx_IL_16BIT_INSTRUCTION_TRAPPED (0x0 << 25)

/**
 * @def ESR_ELx_IL_32BIT_INSTRUCTION_TRAPPED
 * @brief ESR 32-bit AArch32 BKPT instruction or AArch64 BRK instruction.
 */
#define ESR_ELx_IL_32BIT_INSTRUCTION_TRAPPED (0x1 << 25)

/**
 * @def ESR_ELx_ISS_MASK
 * @brief 24-0: Instruction Specific Syndrome.
...
/**
 * @def ESR_ELx_ISS_EA
 * @brief 9: EA, External abort type.
...
/* 7: S1PTW
 * For a stage 2 fault, indicates whether the fault was a stage 2 fault
 * on an access made for a stage 1 translation table walk:
 */
/**
 * @def ESR_ELx_ISS_S1PTW_FAULT_ON_THE_STAGE2
 * @brief Fault not on a stage 2 translation for a stage 1 translation table walk.
 */
#define ESR_ELx_ISS_S1PTW_FAULT_ON_THE_STAGE2 (0x1 << 7)

/**
 * @def ESR_ELx_ISS_S1PTW_FAULT_NOT_ON_THE_STAGE2
 * @brief Fault on the stage 2 translation of an access for a stage 1 translation table walk.
 */
...
/**
 * @def ESR_ELx_ISS_IFSC_MASK
 * @brief 5-0: IFSC, Instruction fault status code. Indicates the fault
 ...
 */
/**
 * @def SPSR_ELx_NEGATIVE_CONDITION_FLAG
...
/**
 * @def SPSR_ELx_ZERO_CONDITION_FLAG
 * @brief Z, bit[30] Zero condition flag.
 */
#define SPSR_ELx_ZERO_CONDITION_FLAG (0x1 << 30)

/**
 * @def SPSR_ELx_CARRY_CONDITION_FLAG
 * C, bit[29] Carry condition flag.
 */
#define SPSR_ELx_CARRY_CONDITION_FLAG (0x1 << 29)

/**
 * @def SPSR_ELx_OVERFLOW_CONDITION_FLAG
...
/**
 * @def SPSR_ELx_SOFTWARE_STEP_BIT
 * @brief 21: Software Step bit.
 */
#define SPSR_ELx_SOFTWARE_STEP_BIT (0x1 << 21)


/**
 * @def SPSR_ELx_ILLEGAL_EXCEPTION_STATE_BIT
 * @brief 20: Illegal Execution State bit.
 */
...
/**
 * @def SPSR_ELx_DEBUG_EXCEPTION_MASK_BIT
 ...
 * @brief A, bit[8] SError interrupt mask bit.
 */
...
/**
 * @def SPSR_ELx_FIQ_MASK_BIT
 * @brief F, bit[6] FIQ mask bit.
 */
...
/**
 * @def SPSR_ELx_MODE_FIELD_MASK
 * @brief SPSR mode field mask.
 */
#define SPSR_ELx_MODE_FIELD_MASK 0x1f

/**
 * @def SPSR_ELx_MODE_FIELD_EL0t
 * @brief SPSR mode field EL0t.
 */
...
/**
 * @def SPSR_ELx_MODE_FIELD_EL1t
 * @brief SPSR mode field EL1t.
 */
#define SPSR_ELx_MODE_FIELD_EL1t 0x4

/**
 * @def SPSR_ELx_MODE_FIELD_EL1h
 * @brief SPSR mode field EL1h.
 */
#define SPSR_ELx_MODE_FIELD_EL1h 0x5

/**
 * @def SPSR_ELx_MODE_FIELD_EL2t
 * @brief SPSR mode field EL2t.
 */
#define SPSR_ELx_MODE_FIELD_EL2t 0x8

/**
 * @def SPSR_ELx_MODE_FIELD_EL2h
 * @brief SPSR mode field EL2h.
 */
#define SPSR_ELx_MODE_FIELD_EL2h 0x9

/**
 * @def SPSR_ELx_MODE_FIELD_EL3t
 * @brief SPSR mode field EL3t.
 */
#define SPSR_ELx_MODE_FIELD_EL3t 0xa

/**
 * @def SPSR_ELx_MODE_FIELD_EL3h
 * @brief SPSR mode field EL3h.
 */
...
/**
 * @def PMUSERENR_ER
 * @brief 3: Event counter read enable.
...
/**
 * @def PMUSERENR_CR
 * @brief 2: Cycle counter read enable.
 * The possible values of this bit are:
...
/**
 * @def PMUSERENR_SW
 * @brief 1: Software Increment write enable.
 * The possible values of this bit are:
...
/**
 * @def PMUSERENR_EN
 * @brief 0: EL0 access enable bit. The possible values of this bit are:
...
/**
 * @def PMCNTENSET_P(x)
 * @brief 30-0: P<x>, bit [x] for x = 0 to (N - 1)
...
/**
 * @def PMCR_IDCODE_MASK
 * @brief 23-16: Identification code.
 * This field is RO with an IMPLEMENTATION DEFINED value.
...
/**
 * @def PMCR_N_MASK
 * @brief 15-11: Number of event counters.
...
/**
 * @def PMCR_LC
 * @brief 6: Long cycle counter enable.
...
/**
 * @def PMCR_DP
 * @brief 5: Disable cycle counter when event counting is prohibited.
 * The possible values of this bit are:
...
/**
 * @def PMCR_X
 * @brief 4: Enable export of events in an IMPLEMENTATION DEFINED event stream.
 * The possible values of this bit are:
...
/**
 * @def PMCR_E
 * @brief 0: Enable. The possible values of this bit are:
...
/**
 * @def SCTLR_ELx_UCI
 * @brief 26: When set, enables EL0 access in AArch64 for DC CVAU, DC CIVAC, DC CVAC,
...
/**
 * @def SCTLR_El1_EE
 * @brief 25: Exception Endianness. This bit controls the endianness for:
...
/**
 * @def SCTLR_ELx_E0E
 * @brief 24: Endianness of explicit data accesses at EL0.
 * The possible values of this bit are:
...
/**
 * @def SCTLR_ELx_nTWE
 * @brief 18: Not trap WFE. Possible values of this bit are:
...
/**
 * @def SCTLR_ELx_nTWI
 * @brief 16: Not trap WFI. Possible values of this bit are:
...
/**
 * @def SCTLR_ELx_UCT
 * @brief 15: When set, enables EL0 access in AArch64 to the CTR_EL0 register.
 * Reset value is architecturally UNKNOWN.
 */
...
/**
 * @def SCTLR_ELx_DZE
 * @brief 14: Access to DC ZVA instruction at EL0. The possible values of this bit are:
...
/**
 * @def SCTLR_ELx_SED
 * @brief 8: SETEND Disable. The possible values of this bit are:
...
/**
 * @def SCTLR_ELx_ITD
 * @brief 7: IT Disable. The possible values of this bit are:
...
/**
 * @def SCTLR_ELx_THEE
 * @brief 6: T32EE enable. The possible values of this bit are:
 * 0 : T32EE is disabled.
 * 1 : T32EE is enabled.
...
/**
 * @def SCTLR_ELx_CP15BEN
 * @brief 5: CP15 barrier enable.
...
/**
 * @def SCTLR_ELx_SA
 * @brief 3: Stack Alignment Check Enable.
 * When set, use of the stack pointer as the base address in a load/store instruction
...
/**
 * @def SCTLR_ELx_C
 * @brief 2: Cache enable. This is an enable bit for data and unified caches at EL0 and EL1:
...
/**
 * @def SCTLR_ELx_A
 * @brief 1: Alignment check enable. This is the enable bit for Alignment fault checking:
...
/**
 * @def SCTLR_ELx_M
 * @brief 0: MMU enable for EL1 and EL0 stage 1 address translation.
...
/**
 * @def CPACR_EL1_TTA
 * @brief 28: Causes access to the Trace functionality to trap to EL1
 * when executed from EL0 or EL1.
...
/**
 * @def CPACR_EL1_FPEN_MASK
 * @brief CPACR EL1 FPEN MASK.
 */
#define CPACR_EL1_FPEN_MASK (0x3 << 20)

/**
 * @def CPACR_EL1_FPEN_CAUSE_EL0_EL1
 * @brief 00 : Causes any instructions in EL0 or EL1 that use the registers associated
 * with Floating Point and Advanced SIMD execution to be trapped.
 */
#define CPACR_EL1_FPEN_CAUSE_EL0_EL1 (0x0 << 20)

/**
 * @def CPACR_EL1_FPEN_CAUSE_EL0
 * @brief 01 : Causes any instructions in EL0 that use the registers associated
 * with Floating Point and Advanced SIMD execution to be trapped, but does not cause
 * any instruction in EL1 to be trapped.
 */
#define CPACR_EL1_FPEN_CAUSE_EL0 (0x1 << 20)

/**
 * @def CPACR_EL1_FPEN_CAUSE_EL0_EL1_2
 * @brief 10 : Causes any instructions in EL0 or EL1 that use the registers associated
 * with Floating Point and Advanced SIMD execution to be trapped.
 */
#define CPACR_EL1_FPEN_CAUSE_EL0_EL1_2 (0x2 << 20)

/**
 * @def CPACR_EL1_FPEN_NOT_CAUSE
 * @brief 11 : Does not cause any instruction to be trapped.
 */
...
#endif /* __MCUBE_AARCH64_SYS_REGS_H__ */
