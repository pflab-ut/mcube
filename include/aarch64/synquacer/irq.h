/**
 * @file include/aarch64/synquacer/irq.h
 *
 * @author Hiroyuki Chishiro
 */
#ifndef __MCUBE_AARCH64_SYNQUACER_IRQ_H__
#define __MCUBE_AARCH64_SYNQUACER_IRQ_H__
...
#endif /* __MCUBE_AARCH64_SYNQUACER_IRQ_H__ */
