/**
 * @file include/aarch64/raspi3/dmac.h
 *
 * @author Hiroyuki Chishiro
 */
#ifndef __MCUBE_AARCH64_RASPI3_DMAC_H__
#define __MCUBE_AARCH64_RASPI3_DMAC_H__
 ...
 * @param ch Channel.
 */
#define DMAC_CH_BASE(ch) (DMAC_BASE + (ch) * 0x100)

/**
 * @def DMAC_CH_CS(ch)
 * @brief DMAC control and status.
 *
 * @param ch Channel.
 */
#define DMAC_CH_CS(ch) (DMAC_CH_BASE(ch) + 0x0)

/**
 * @def DMAC_CH_CONBLK_ADDR(ch)
 * @brief DMAC control block address.
 *
 * @param ch Channel.
 */
#define DMAC_CH_CONBLK_ADDR(ch) (DMAC_CH_BASE(ch) + 0x4)

/**
 * @def DMAC_CH_TI(ch)
 * @brief DMAC transfer information.
 *
 * @param ch Channel.
 */
#define DMAC_CH_TI(ch) (DMAC_CH_BASE(ch) + 0x8)

/**
 * @def DMAC_CH_SRC_ADDR(ch)
 * @brief DMAC source address.
 *
 * @param ch Channel.
 */
#define DMAC_CH_SRC_ADDR(ch) (DMAC_CH_BASE(ch) + 0xc)

/**
 * @def DMAC_CH_DST_ADDR(ch)
 * @brief DMAC destination address.
 *
 * @param ch Channel.
 */
#define DMAC_CH_DST_ADDR(ch) (DMAC_CH_BASE(ch) + 0x10)

/**
 * @def DMAC_CH_TRANSFER_LEN(ch)
 * @brief DMAC transfer length.
 *
 * @param ch Channel.
 */
#define DMAC_CH_TRANSFER_LEN(ch) (DMAC_CH_BASE(ch) + 0x14)

/**
 * @def DMAC_CH_STRIDE(ch)
 * @brief DMAC 2D stride.
 *
 * @param ch Channel.
 */
#define DMAC_CH_STRIDE(ch) (DMAC_CH_BASE(ch) + 0x18)

/**
 * @def DMAC_CH_NEXTCONBK(ch)
 * @brief DMAC next control block address.
 *
 * @param ch Channel.
 */
#define DMAC_CH_NEXTCONBK(ch) (DMAC_CH_BASE(ch) + 0x1c)

/**
 * @def DMAC_CH_DEBUG(ch)
 * @brief DMAC debug.
 *
 * @param ch Channel.
 */
#define DMAC_CH_DEBUG(ch) (DMAC_CH_BASE(ch) + 0x20)

/**
 * @def DMAC_INT_STATUS
 * @brief DMAC interrupt status.
 */
...
/**
 * @def DMAC_CH_CS_RESET
 * @brief 31: DMA Channel Reset.
...
/**
 * @def DMAC_CH_CS_DISDEBUG
 * @brief 29: Disable debug pause signal.
 * When set to 1, the DMA will not stop when the debug pause signal is asserted.
 */
#define DMAC_CH_CS_DISDEBUG (0x1 << 29)

/**
 * @def DMAC_CH_CS_WAIT_FOR_OUTSTANDING_WRITES
 * @brief 28: Wait for outstanding writes
...
/**
 * @def DMAC_CH_CS_PANIC_PRIORITY_MASK
 * @brief 23-20: AXI Panic Priority Level.
...
/**
 * @def DMAC_CH_CS_PRIORITY_MASK
 * @brief 19-16: AXI Priority Level.
...
/**
 * @def DMAC_CH_CS_WAITING_FOR_OUTSTANDING_WRITES
 * @brief 6: DMA is Waiting for the Last Write to be Received.
...
/**
 * @def DMAC_CH_CS_DREQ_STOPS_DMA
 * @brief 5: DMA Paused by DREQ State.
...
/**
 * @def DMAC_CH_CS_PAUSED
 * @brief 4: DMA Paused State.
...
/**
 * @def DMAC_CH_CS_ACTIVE
 * @brief 0: Activate the DMA.
...
/**
 * @def DMAC_CH_CONBLK_ADDR_MASK
 * @brief 31-0: Control Block Address.
...
/**
 * @def DMAC_CH_TI_NO_WIDE_BURSTS
 * @brief 26: Don't Do wide writes as a 2 beat burst.
...
/**
 * @def DMAC_CH_TI_WAITS_MASK
 * @brief 25: Add Wait Cycles.
...
/**
 * @def DMAC_CH_TI_PREMAP_MASK
 * @brief 20-16: Peripheral Mapping.
...
/**
 * @def DMAC_CH_TI_BURST_LENGTH_MASK
 * @brief 15-12: Burst Transfer Length.
...
/**
 * @def DMAC_CH_TI_SRC_IGNORE
 * @brief 11: Ignore Reads.
...
/**
 * @def DMAC_CH_TI_SRC_DREQ
 * @brief 10: Control Source Reads with DREQ.
...
/**
 * @def DMAC_CH_TI_SRC_WIDTH
 * @brief 9: Source Transfer Width.
...
/**
 * @def DMAC_CH_TI_SRC_INC
 * @brief 8: Source Address Increment.
...
/**
 * @def DMAC_CH_TI_DST_IGNORE
 * @brief 7: Ignore Writes.
...
/**
 * @def DMAC_CH_TI_DST_DREQ
 * @brief 6: Control Destination Writes with DREQ.
...
/**
 * @def DMAC_CH_TI_DST_WIDTH
 * @brief 5: Destination Transfer Width.
...
/**
 * @def DMAC_CH_TI_DST_INC
 * @brief 4: Destination Address Increment.
...
/**
 * @def DMAC_CH_TI_WAIT_RESP
 * @brief 3: Wait for a Write Response.
...
/**
 * @def DMAC_CH_TI_INTEN
 * @brief 0: Interrupt Enable
...
/**
 * @def DMAC_CH_TI2_WAITS_MASK
 * @brief 25-21: Add Wait Cycles.
...
/**
 * @def DMAC_CH_TI2_BURST_LENGTH_MASK
 * @brief 15-12: Burst Transfer Length.
 * Indicates the burst length of the DMA transfers.
 * The DMA will attempt to transfer data as bursts of this number of words.
 * A value of zero will produce a single transfer.
...
/**
 * @def DMAC_CH_SRC_ADDR_MASK
 * @brief 31-0: DMA Source Address.
...
/**
 * @def DMAC_CH_DST_ADDR_MASK
 * @brief 31-0: DMA Destination Address.
...
/**
 * @def DMAC_CH_TRANSFER_LEN_YLENGTH_MASK
 * @brief 29-16: When in 2D mode, This is the Y transfer length,
...
/**
 * @def DMAC_CH_TRANSFER_LEN_XLENGTH_MASK
 * @brief 15-0: Transfer Length in bytes.
 */
...
/**
 * @def DMAC_CH_TRANSFER_LEN2_XLENGTH_MASK
 * @brief 15-0: Transfer Length in bytes.
 */
...
/**
 * @def DMAC_CH_STRIDE_DST_STRIDE_MASK
 * @brief 31-16: Destination Stride (2D Mode)
...
/**
 * @def DMAC_CH_STRIDE_SRC_STRIDE_MASK
 * @brief 15-0: Source Stride (2D Mode)
...
/**
 * @def DMAC_CH_NEXTCONBK_ADDR_MASK
 * @brief 31-0: Address of next CB for chained DMA operations.
 */
...
/**
 * @def DMAC_CH_DEBUG_OUTSTANDING_WRITES
 * @brief 7-4: DMA Outstanding Writes Counter.
...
/**
 * @def DMAC_CH_DEBUG_READ_ERROR
 * @brief 2: Slave Read Response Error.
...
/**
 * @def DMAC_CH_DEBUG_READ_LAST_NOT_SET_ERROR
 * @brief 0: Read Last Not Set Error
...
/**
 * @def DMAC_CH_DEBUG2_OUTSTANDING_WRITES
 * @brief 7-4: DMA Outstanding Writes Counter.
 * Returns the number of write responses that have not yet been received.
 * This count is reset at the start of each new DMA transfer or with a DMA reset.
 */
...
/**
 * @def DMAC_CH_DEBUG2_READ_LAST_NOT_SET_ERROR
 * @brief 0: Read Last Not Set Error.
 * If the AXI read last signal was not set when expected,
 * then this error bit will be set. It can be cleared by writing a 1.
 */
...
/* 31-16: reserved */
/**
 * @def DMAC_INT_STATUS_INT(x)
 * @brief 15-0: Interrupt Status of DMA Engines 15-0.
 *
 * @param x DMA engine.
 */
...
/* 31-15: reserved */
/**
 * @def DMAC_ENABLE_EN(x)
 * @brief 14-0: Enable DMA Engines 14-0.
 *
 * @param x DMA engine.
 */
...
struct dmac_info {
   ...
   */
  uint32_t padding;
} __aligned(32) /** aligned. */;

#endif /* !__ASSEMBLY__ */


#endif /* __MCUBE_AARCH64_RASPI3_DMAC_H__ */
