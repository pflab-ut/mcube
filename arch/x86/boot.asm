...
;
;   nasm -f bin -o boot.sys boot.asm
;
...
; Display strings
String.Loader.Found     db      "[Mcube] Loader found",          0x0d, 0x0a, 0
String.Loader.Starting  db      "[Mcube] Loader starting",       0x0d, 0x0a, 0
String.Fail             db      "[Mcube] ERROR: Failed to load", 0x0d, 0x0a, 0
