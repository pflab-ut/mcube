...
void init_timer(unsigned long tick_us)
{
  ...
  mmio_out32(TIMER_LOCAL_TIMER_WRITE_FLAGS,
             TIMER_LOCAL_TIMER_WRITE_FLAGS_INTERRUPT_FLAG_CLEAR
             | TIMER_LOCAL_TIMER_WRITE_FLAGS_LOCAL_TIMER_RELOADED);
  printk("cpu = %lu\n", cpu);
  switch (cpu) {
  case 0:
    ...
    mmio_out32(TIMER_CORE0_TIMERS_INTERRUPT_CTRL,
               TIMER_CORE_TIMERS_INTERRUPT_CTRL_CNTVIRQ_IRQ_CTRL);
    /* local timer interrupt goes to Core 0 IRQ */
    mmio_out32(TIMER_LOCAL_INTERRUPT_ROUTING,
               TIMER_LOCAL_INTERRUPT_ROUTING_CORE0_IRQ);
    break;
  case 1:
    ...
    mmio_out32(TIMER_CORE1_TIMERS_INTERRUPT_CTRL,
               TIMER_CORE_TIMERS_INTERRUPT_CTRL_CNTVIRQ_IRQ_CTRL);
    /* local timer interrupt goes to Core 1 IRQ */
    mmio_out32(TIMER_LOCAL_INTERRUPT_ROUTING,
               TIMER_LOCAL_INTERRUPT_ROUTING_CORE1_IRQ);
    break;
  case 2:
    ...
    mmio_out32(TIMER_CORE2_TIMERS_INTERRUPT_CTRL,
               TIMER_CORE_TIMERS_INTERRUPT_CTRL_CNTVIRQ_IRQ_CTRL);
    /* local timer interrupt goes to Core 2 IRQ */
    mmio_out32(TIMER_LOCAL_INTERRUPT_ROUTING,
               TIMER_LOCAL_INTERRUPT_ROUTING_CORE2_IRQ);
    break;
  case 3:
    ...
    mmio_out32(TIMER_CORE3_TIMERS_INTERRUPT_CTRL,
               TIMER_CORE_TIMERS_INTERRUPT_CTRL_CNTVIRQ_IRQ_CTRL);
    /* local timer interrupt goes to Core 3 IRQ */
    mmio_out32(TIMER_LOCAL_INTERRUPT_ROUTING,
               TIMER_LOCAL_INTERRUPT_ROUTING_CORE3_IRQ);
    break;
  default:
